...
| `--info` | `oklch(0.55 0.14 240)` | تلميحات، روابط تعليمية، إشعارات محايدة |
...
- الأنصاف: `rounded-lg` للمدخلات، `rounded-xl` للبطاقات، `rounded-full` للأزرار الدائرية والشارات النقطية.
