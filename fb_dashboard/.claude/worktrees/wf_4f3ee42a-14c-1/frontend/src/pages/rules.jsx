          ...
          <table className="w-full">
            <thead>
              <tr className="bg-muted/50 border-b">
                <th className="text-xs font-semibold text-muted-foreground px-4 py-3.5 text-right">القاعدة</th>
                <th className="text-xs font-semibold text-muted-foreground px-4 py-3.5 text-right">النوع</th>
                <th className="text-xs font-semibold text-muted-foreground px-4 py-3.5 text-right">الكلمات المفتاحية</th>
                <th className="text-xs font-semibold text-muted-foreground px-4 py-3.5 text-right w-1/3">الرد</th>
                <th className="text-xs font-semibold text-muted-foreground px-4 py-3.5 text-right">الحالة</th>
                <th className="text-xs font-semibold text-muted-foreground px-4 py-3.5 text-right w-28">إجراءات</th>
              </tr>
            </thead>
