    ...
    <header className="sticky top-0 z-40 flex h-14 shrink-0 items-center justify-between border-b bg-background/80 backdrop-blur-xl px-4 lg:px-6">
      ...
      <div className="flex items-center gap-4 overflow-hidden">
        ...
        <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
          ...
          <SheetContent side="right" className="w-[280px] p-0 bg-card border-l border-border">
                ...
                .map((item) => {
                  ...
                  return (
                    <button
                      ...
                      style={active ? { backgroundColor: 'hsl(var(--primary))', boxShadow: '0 0 12px hsl(var(--primary) / 0.4)' } : undefined}
                    >
