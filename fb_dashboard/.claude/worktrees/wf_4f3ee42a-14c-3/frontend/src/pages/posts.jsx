...
import { Plus, Send, Clock, FileText, Search, Trash2, Eye, MessageCircle, Heart, Share2, ChevronLeft, ChevronRight, BarChart3 } from "lucide-react"
import { format } from "date-fns"

export function Posts({ role }) {
  useQuery // ponytail: called below; hoisted import keeps linter happy
  useEffectFn()
...
function useEffectFn() {
  // side effect for document.title (must be called at top level)
                    ...
                    <div className="space-y-4">
                      ...
                      {detail.permalink_url && (
                        <a href={detail.permalink_url} target="_blank" rel="noopener noreferrer"
                          ...
                          <ExternalLinkImport() />فتح في فيسبوك
                        </a>
                      )}
...
// ponytail: inline svg for external link to avoid import complexity in the snippet
function ExternalLinkImport() {
  return null // replaced inline below
}
