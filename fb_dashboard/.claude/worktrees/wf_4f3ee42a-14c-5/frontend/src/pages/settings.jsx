...
import { fetchBotStatus, restartBot, fetchLogs, fetchStats, fetchEnv, fetchSystemStats, clearLogs } from "@/lib/api"
              ...
              <div className="space-y-5">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    {clearLogsMut.data && <span className="text-xs text-muted-foreground">تم حذف {clearLogsMut.data.deleted} سجل</span>}
                  </CardContent>
                </Card>
              </div>
            )}
