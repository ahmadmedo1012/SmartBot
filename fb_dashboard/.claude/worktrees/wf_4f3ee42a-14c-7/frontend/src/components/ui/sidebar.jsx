...
import { PanelRight as PanelLeft } from "lucide-react"
...
const Sidebar = React.forwardRef((
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn(
          "flex h-full min-w-[208px] w-[208px] max-w-[208px] flex-col bg-sidebar text-sidebar-foreground",
          className
        )}
        ref={ref}
        {...props}>
  ...
  return (
    <div
      ...
      <div
        className={cn(
          "relative min-w-[208px] w-[208px] max-w-[208px] bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh min-w-[208px] w-[208px] max-w-[208px] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
const SidebarRail = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-[width] ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-start text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
