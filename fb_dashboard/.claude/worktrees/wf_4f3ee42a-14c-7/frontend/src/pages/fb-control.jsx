...
import { Square, RefreshCw, Bot, Smartphone, WifiOff, CheckCircle2, AlertTriangle } from "lucide-react"
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 text-center space-y-3">
      ...
      <Button variant="outline" size="sm" onClick={onRetry}>
        <RefreshCw className="ml-1 h-3 w-3" />إعادة المحاولة
      </Button>
    </div>
  )
}
        ...
        <Card>
          ...
          <CardContent>
            {statusLoading ? (
              ...
              <ErrorState error={new Error("تعذر تحميل الحالة")} onRetry={refetchStatus} />
            ) : (
