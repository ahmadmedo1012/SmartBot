  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden login-bg">
      <div className="absolute inset-0 z-0" aria-hidden="true">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full rounded-full login-glow-primary" />
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full rounded-full login-glow-secondary" />
      </div>
      <Particles />
