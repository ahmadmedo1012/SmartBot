...
تعليمات:
1. الردود باللهجة الليبية العامية (شنو، شكون، شحال، قداش، باهي، زين، قدها، هكاك)
2. استخدم أسلوب مهذب وحنون ومحترف
3. قدم 3 اقتراحات ردود: قصير (جملة)، متوسط (جملتين)، طويل (3 جمل)
4. كل رد يبدأ باسم العميل
5. إذا استفسار عن سعر ← أضف دعوة للخاص مع عرض
6. إذا شكوى ← اعتذار ووعد بالتعويض والتواصل على الخاص
...
_ANALYZE_TONE_SYSTEM = """أنت محلل مشاعر متخصص في اللهجة الليبية. حلل التعليق:
{{
