...
_NEGATIVE = {
    ...
    "خربان", "تعبان", "مقرفه", "مقرفين", "قرفان",
...
_CONTACT = {
    ...
    "اتصال", "اتصل", "ناديني", "نادني", "بص خاص",
