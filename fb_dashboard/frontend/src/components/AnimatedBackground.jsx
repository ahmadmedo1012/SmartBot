...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      g1.addColorStop(0, "hsla(142, 70%, 45%, 0.04)"); g1.addColorStop(1, "transparent")
      ...
      g2.addColorStop(0, "hsla(225, 60%, 60%, 0.03)"); g2.addColorStop(1, "transparent")
      ...
      g3.addColorStop(0, "hsla(190, 70%, 50%, 0.03)"); g3.addColorStop(1, "transparent")
