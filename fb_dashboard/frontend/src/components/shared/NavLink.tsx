...
export function NavLink({ href, label, icon: Icon, onClick, exact }: NavLinkProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group relative flex min-h-11 items-center gap-3 overflow-hidden rounded-xl px-3 py-2 text-sm font-medium transition-[color,background-color,box-shadow] duration-200 focus-visible:ring-2 focus-visible:ring-accent-foreground/60",
        isActive
