 ...
 * (AA 4.5:1 measured in both modes — see globals.css) and the focus-glow
 * shadow now derives from var(--ring) via color-mix instead of the literal
 * oklch(0.55 0.19 45 / 0.12) (identical rendering, single source). */
