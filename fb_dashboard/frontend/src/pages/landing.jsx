              ...
              <div className="glass-card rounded-3xl overflow-hidden w-full max-w-lg"
                ...
                <svg viewBox="0 0 480 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto" role="img" aria-label="لوحة تحكم SmartBot">
                  ...
                  <defs>
                    ...
                    <linearGradient id="ac" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#c53c00"/><stop offset="100%" stopColor="#9a3a00"/></linearGradient>
                    <linearGradient id="acg" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#c53c00" stopOpacity="0.2"/><stop offset="100%" stopColor="#c53c00" stopOpacity="0"/></linearGradient>
                  </defs>
                  {/* Top bar */}
                  <rect x="16" y="12" width="448" height="40" rx="10" fill="#1a181d" />
                  <text x="44" y="37" fill="#c53c00" fontSize="11" fontWeight="700" fontFamily="system-ui">SmartBot</text>
                  <rect x="340" y="22" width="20" height="20" rx="6" fill="#c53c00" opacity="0.15"/>
                  <rect x="370" y="22" width="20" height="20" rx="6" fill="#c53c00" opacity="0.15"/>
                  <rect x="400" y="22" width="20" height="20" rx="6" fill="#c53c00" opacity="0.15"/>
                  <circle cx="434" cy="32" r="10" fill="#c53c00" opacity="0.2"/>
                  {/* Stat cards */}
                  <rect x="16" y="64" width="108" height="72" rx="10" fill="#1a181d" stroke="#27252a" strokeWidth="1"/>
                  <rect x="26" y="72" width="22" height="22" rx="6" fill="#c53c00" opacity="0.15"/>
                  ...
                  <rect x="36" y="180" width="16" height="44" rx="3" fill="url(#acg)" /><rect x="36" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  <rect x="58" y="160" width="16" height="64" rx="3" fill="url(#acg)" /><rect x="58" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  <rect x="80" y="190" width="16" height="34" rx="3" fill="url(#acg)" /><rect x="80" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  <rect x="102" y="170" width="16" height="54" rx="3" fill="url(#acg)" /><rect x="102" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  <rect x="124" y="150" width="16" height="74" rx="3" fill="url(#acg)" /><rect x="124" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  <rect x="146" y="180" width="16" height="44" rx="3" fill="url(#acg)" /><rect x="146" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  <rect x="168" y="200" width="16" height="24" rx="3" fill="url(#acg)" /><rect x="168" y="224" width="16" height="2" rx="1" fill="#c53c00" />
                  {/* Side panel */}
                  ...
                  <circle cx="340" cy="187" r="3" fill="#c53c00"/>
                  ...
                  <circle cx="340" cy="223" r="3" fill="#c53c00"/>
                  ...
                  {/* Bottom actions */}
                  <rect x="16" y="288" width="88" height="32" rx="8" fill="#c53c00"/>
